...
router.route('/items').get(validate({}), categoryController.getCategorieItems);
 ...
 * /categories/items:
 *   get:
 *     summary: Get categories with top 12 items
 *     description: Get categories with top 12 items
 *     tags: [Categories]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *               status: 1
 *               collections: []
 *               description: Tiếng kêu của quàng thượng
 *               sort: 2
 *     responses:
 *       "200":
 *         description: OK
